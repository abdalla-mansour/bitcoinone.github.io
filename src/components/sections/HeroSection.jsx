            ...
            <div className="col-span-2 lg:flex gap-4 lg:mb-12">
              ...
              <DropdownButton name="Download App" className="w-full lg:w-auto">
                <a
                  ...
                  target="_blank"
                  className="w-full hover:bg-primary px-6 pt-4 pb-2 block hover:text-cyan-500"
                >
                ...
                <a
                  href="/download/linux"
                  target="_blank"
                  className="w-full hover:bg-primary px-6 py-2 block hover:text-cyan-500"
                >
                ...
                <a
                  href="/download/ios"
                  target="_blank"
                  className="w-full hover:bg-primary px-6 pb-4 pt-2 block hover:text-cyan-500"
                >
